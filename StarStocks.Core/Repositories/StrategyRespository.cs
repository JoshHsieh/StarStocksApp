...
{
    public sealed class StrategyRespository : AbstractRepository<StrategyResult>
    {
        ...
        public StrategyRespository(IUnitOfWork unit) : base(unit)
        {
            ...
            Dapper.SqlMapper.SetTypeMap(
                ...
                new ColumnAttributeTypeMapper<StrategyResult>());
        }
    }
}
